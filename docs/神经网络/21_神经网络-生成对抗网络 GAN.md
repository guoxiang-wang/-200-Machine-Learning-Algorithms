...
![21_神经网络-生成对抗网络 GAN-1.png](../assets/神经网络/图片和附件/21_神经网络-生成对抗网络 GAN-1.png)

2. **Epoch 10**：生成的图像有些“数字轮廓”，但形状不标准

![21_神经网络-生成对抗网络 GAN-2.png](../assets/神经网络/图片和附件/21_神经网络-生成对抗网络 GAN-2.png)

3. **Epoch 30\+**：许多数字接近真实，但还有些变形

![21_神经网络-生成对抗网络 GAN-3.png](../assets/神经网络/图片和附件/21_神经网络-生成对抗网络 GAN-3.png)

4. **Epoch 50**：图像清晰可辨，数字基本上都符合 MNIST 风格

![21_神经网络-生成对抗网络 GAN-4.png](../assets/神经网络/图片和附件/21_神经网络-生成对抗网络 GAN-4.png)
