...
![20_异常值处理方法-IQR（四分位距）法-1.png](../assets/异常值处理方法/图片和附件/20_异常值处理方法-IQR（四分位距）法-1.png)
...
![20_异常值处理方法-IQR（四分位距）法-2.png](../assets/异常值处理方法/图片和附件/20_异常值处理方法-IQR（四分位距）法-2.png)
