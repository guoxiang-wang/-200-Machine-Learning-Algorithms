...
![20_异常值处理方法-Z-Score 标准化-1.png](../assets/异常值处理方法/图片和附件/20_异常值处理方法-Z-Score 标准化-1.png)
...
![20_异常值处理方法-Z-Score 标准化-2.png](../assets/异常值处理方法/图片和附件/20_异常值处理方法-Z-Score 标准化-2.png)
